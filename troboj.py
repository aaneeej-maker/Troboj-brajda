...
def calc_pts(row, razred_ime):
    try:
        ...
        # Izračun sekund za 600m iz dveh stolpcev
...
if not dejanski.empty:
    ...
    # Tukaj vidiš vse ločeno in preračunano
